    ...
    <div class="container-fluid py-4 mt-3">
        ...
        <form class="row needs-validation">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-12">
                    <textarea class="form-control" id="descripcion" rows="3" required>{{$data == null ? '': $data['descripcion']}}</textarea>
                </div>
            </div>
            <div class="row mt-2">
                <label for="responsable" class="col-form-label">Responsable de Proyecto:</label>
                <div class="input-group">
                    <select class="form-select" id="responsable" aria-label="ResponsableProyecto" required>
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" id="url" value="{{$data == null ? '': $data['url']}}" required>
                </div>
            </div>
            <div class="row mt-2">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-12">
                    <div class="col-auto">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="disponibilidad" value="{{$data == null ? '': $data['disponibilidad']}}" required>
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" id="periodos" value="{{$data == null ? '': $data['periodos']}}" required>
                </div>
            </div>
            <div class="row mt-2">
                <label for="codigo_fuente" class="col-sm-3 col-form-label">Código fuente:</label>
                <div class="col-sm-12">
                    <input type="text" class="form-control" id="codigo_fuente" value="{{$data == null ? '': $data['codigo_fuente']}}" required>
                </div>
            </div>
            <div class="row mt-2">
