                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" id="txtTelefonoSolicitante" name="txtTelefonoSolicitante" class="form-control" value="" maxlength="10" onkeypress="return event.charCode>=48 && event.charCode<=57" >
                                            </div>
                                        </div>
...
<script>
    ...
    function msjeAlerta2(titulo, contenido, icono){
        ...
        urlEditar = urlEditar.replace(':id', 101);
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data[0]['inssolicservicio']==false){  
                    msjeAlerta2('REGISTRO EXITOSO DE ORDEN DE SERVICIO','EL FOLIO DE SERVICIO DE TU ORDEN ES: O2023-00073 ','success')
                }else{ 
