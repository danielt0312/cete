...
<body>
    ...
    <table class="sinbordetable">
                <tr class="sinbordetable">
                  ...
                  <td class="sinbordetable"><span>Estatus: <b>{{ $fn_inf_orden->estatus }}</b></span>
                  @else
                  <td class="sinbordetable"><span>Estatus: <b>{{ $fn_solicitud->estatus }}</b></span>
                  @endif
                  @if($fn_inf_orden != null)
                  <td class="sinbordetable"><span>Folio Orden: <b>{{ $fn_inf_orden->folio }}</b></span>
                  @endif
                </tr>
