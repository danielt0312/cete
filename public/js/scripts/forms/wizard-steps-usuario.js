...
//        vertical Wizard       //
// ------------------------------
$(".wizard-vertical-usuarios").steps({
    headerTag: "h3",
    bodyTag: "fieldset",
    ...
    onFinished: function (event, currentIndex) {
      $('.wizard-vertical-usuarios').submit();
    //   imprimirEquipos();
    }
  });
  ...
  $('.wizard-vertical-usuarios [role="menuitem"]').removeClass("btn-primary").addClass("btn-light-primary");